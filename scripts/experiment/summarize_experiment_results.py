...
DEFAULT_FILES = {
    ...
    "candidate_questions": "aiops-docs/experiment/rag/candidates/batch1/rag_candidate_questions.jsonl",
    "reviewed_candidates": "aiops-docs/experiment/rag/reviews/batch1/rag_candidate_questions.reviewed.jsonl",
    "candidate_review_import_report": "aiops-docs/experiment/rag/reviews/batch1/candidate_review_import_report.json",
    "rag_dataset": "aiops-docs/experiment/rag/datasets/pilot/experiment_rag_dataset.jsonl",
    "validated_dataset": "aiops-docs/experiment/rag/datasets/pilot/experiment_rag_dataset.validated.jsonl",
    "rag_validation_report": "aiops-docs/experiment/rag/datasets/pilot/rag_validation_report.json",
    "rag_split_report": "aiops-docs/experiment/rag/splits/pilot/rag_split_report.json",
    "rag_build": "aiops-docs/experiment/rag/splits/pilot/rag_build.jsonl",
    "rag_dev": "aiops-docs/experiment/rag/splits/pilot/rag_dev.jsonl",
    "rag_test": "aiops-docs/experiment/rag/splits/pilot/rag_test.jsonl",
    "rag_reserve": "aiops-docs/experiment/rag/splits/pilot/rag_reserve.jsonl",
    "retrieval_dense_no_rerank_build": "aiops-docs/experiment/results/retrieval/pilot/dense_no_rerank_build.json",
    "retrieval_dense_no_rerank_dev": "aiops-docs/experiment/results/retrieval/pilot/dense_no_rerank_dev.json",
    "retrieval_dense_current_rerank_build": "aiops-docs/experiment/results/retrieval/pilot/dense_current_rerank_build.json",
    "retrieval_dense_current_rerank_dev": "aiops-docs/experiment/results/retrieval/pilot/dense_current_rerank_dev.json",
    "retrieval_comparison": "aiops-docs/experiment/results/retrieval/pilot/retrieval_experiment_comparison.json",
    "confidence_rank_and_margin_build": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_dense_current_rerank_build.json",
    "confidence_rank_and_margin_dev": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_dense_current_rerank_dev.json",
    "confidence_system_top3_support_build": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_system_top3_support_dense_current_rerank_build.json",
    "confidence_system_top3_support_dev": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_system_top3_support_dense_current_rerank_dev.json",
    "confidence_tuning_build": "aiops-docs/experiment/results/confidence/tuning/confidence_tuning_system_top3_support_build.json",
    "confidence_tuning_dev": "aiops-docs/experiment/results/confidence/tuning/confidence_tuning_system_top3_support_dev.json",
    "confidence_score_threshold_build": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_score_threshold_dense_current_rerank_build.json",
    "confidence_score_threshold_dev": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_score_threshold_dense_current_rerank_dev.json",
    "confidence_score_margin_build": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_score_margin_dense_current_rerank_build.json",
    "confidence_score_margin_dev": "aiops-docs/experiment/results/confidence/baseline/confidence_eval_score_margin_dense_current_rerank_dev.json",
}
